...
(async () => {
    ...
    try {
        ...
        // 生成未压缩css
        fs.writeFileSync(`./dist/hs-css-for-html5-v${version_name.get_version_name()}.css`, unCompressedCss);

        // 生成压缩css
        fs.writeFileSync(`./dist/hs-css-for-html5-v${version_name.get_version_name()}.min.css`, compressedCss);
